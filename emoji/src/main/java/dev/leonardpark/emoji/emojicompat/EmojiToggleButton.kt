...
class EmojiToggleButton : AppCompatToggleButton {
  ...
  constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
    ...
    emojiSize = if (attrs == null) {
      ...
      val a = getContext().obtainStyledAttributes(attrs, R.styleable.EmojiToggleButton)
      try {
